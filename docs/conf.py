# -*- coding: utf-8 -*-
#
# Pulp Container Support documentation build configuration file, created by modifying a config
# built by sphinx-quickstart on Thu Nov 20 17:53:15 2014.
#
...
project = u'Pulp Container Support'
