# Generated by Django 3.2.13 on 2022-07-29 12:57
...
class Migration(migrations.Migration):
    ...
    replaces = [('container', '0001_initial'), ('container', '0002_containerrepository'), ('container', '0003_oci_mediatype'), ('container', '0004_upload'), ('container', '0005_contentredirectcontentguard'), ('container', '0006_containerpushrepository'), ('container', '0007_clear_tags_artifacts_refs'), ('container', '0008_include_exclude_tags'), ('container', '0009_container_namespace'), ('container', '0010_remove_uploadchunk'), ('container', '0011_add_container_repository_permissions'), ('container', '0012_add_container_namespace_permissions'), ('container', '0013_add_pull_push_permissions'), ('container', '0014_containerdistribution_private'), ('container', '0015_manage_tags_push_repo'), ('container', '0016_add_delete_versions_permission'), ('container', '0017_add_granular_perms'), ('container', '0018_containerdistribution_description'), ('container', '0019_DATA_distribution_model_swap'), ('container', '0020_update_push_repo_perms'), ('container', '0021_data_move_redirect_content_guard_to_core'), ('container', '0022_delete_contentredirectcontentguard'), ('container', '0023_manifestsignature'), ('container', '0024_containerremote_sigstore'), ('container', '0025_signature_stored_in_textfield'), ('container', '0026_manifest_signing_service'), ('container', '0027_data_translate_perms_to_roles'), ('container', '0028_add_role_manage_permissions'), ('container', '0029_remove_blob_media_type'), ('container', '0030_enforce_tagged_manifest_reference'), ('container', '0031_replace_charf_with_textf'), ('container', '0032_upload_artifact')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'default_related_name': '%(app_label)s_%(model_name)s',
                'permissions': [('pull_containerdistribution', 'Can pull from a registry repo'), ('push_containerdistribution', 'Can push into the registry repo'), ('manage_roles_containerdistribution', 'Can manage role assignments on container distribution')],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manifest_signing_service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='container_containerpushrepository', to='container.manifestsigningservice')),
            ],
            options={
                'default_related_name': '%(app_label)s_%(model_name)s',
                'permissions': [('modify_content_containerpushrepository', 'Can modify content in a push repository'), ('manage_roles_containerpushrepository', 'Can manage role assignments on container pushrepository')],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manifest_signing_service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='container_containerrepository', to='container.manifestsigningservice')),
            ],
            options={
                'default_related_name': '%(app_label)s_%(model_name)s',
                'permissions': [('sync_containerrepository', 'Can start a sync task'), ('modify_content_containerrepository', 'Can modify content in a repository'), ('build_image_containerrepository', 'Can use the image builder in a repository'), ('delete_containerrepository_versions', 'Can delete repository versions'), ('manage_roles_containerrepository', 'Can manage role assignments on container repository')],
            },
            bases=('core.repository',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include_tags', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(null=True), null=True, size=None)),
                ('exclude_tags', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(null=True), null=True, size=None)),
                ('sigstore', models.TextField(null=True)),
            ],
            options={
                'default_related_name': '%(app_label)s_%(model_name)s',
                'permissions': [('manage_roles_containerremote', 'Can manage role assignments on container remote')],
            },
            bases=('core.remote',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(db_index=True)),
                ('tagged_manifest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_manifests', to='container.manifest')),
            ],
            options={
                'default_related_name': '%(app_label)s_%(model_name)s',
