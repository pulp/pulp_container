...
then
  ...
  USE_LOCAL_API_JSON=1 ./generate.sh pulp_container python "$VERSION"
else
...
twine check "dist/pulp_container_client-$VERSION-py3-none-any.whl"
twine check "dist/pulp_container-client-$VERSION.tar.gz"
