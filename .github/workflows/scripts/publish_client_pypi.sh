...
VERSION="$(ls dist | sed -rn 's/pulp_container-client-(.*)\.tar.gz/\1/p')"
...
RESPONSE="$(curl --write-out '%{http_code}' --silent --output /dev/null "https://pypi.org/project/pulp-container-client/$VERSION/")"
