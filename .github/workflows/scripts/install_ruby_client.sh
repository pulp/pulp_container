...
then
  curl --fail-with-body -k -o api.json "${PULP_URL}${PULP_API_ROOT}api/v3/docs/api.json?bindings&component=container"
  USE_LOCAL_API_JSON=1 ./generate.sh pulp_container ruby "$VERSION"
else
