...
if [ "$TEST" = "azure" ]; then
  file /usr/local/share/ca-certificates/azcert.crt /opt/az/lib/python3.6/site-packages/certifi/cacert.pem
  cmd_prefix file /usr/local/lib/python3.8/site-packages/certifi/cacert.pem
